...
const Hero = () => {
  return (
    <motion.section
      id="home"
      className="relative min-h-screen flex items-center bg-gradient-to-br from-green-50 to-emerald-100 scroll-mt-20"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
                className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 pt-8 justify-center"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: false, amount: 0.3 }}
              variants={{
          ...
          >
            ...
            >
              ...
              />
              <div className="mt-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Conseil Professionnel</h3>
                <p className="text-gray-600">Solutions sur mesure pour vos besoins agricoles</p>
              </div>
            </motion.div>
          </motion.div>
        </div>
