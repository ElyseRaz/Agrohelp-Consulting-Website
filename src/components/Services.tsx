      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="flex items-center justify-center mb-2">
            <Briefcase className="text-green-600 mr-2" size={36} />
            <h2 className="text-4xl font-bold text-green-700 mb-0">Nos Services</h2>
          </span>
        ...
        >
          {services.map((service, index) => (
            ...
            >
              <motion.div
                className="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-200"
